                    ...
                    try {
                      const res = await fetch("/api/send-order-email", {
                        ...
                        body: JSON.stringify({
                          ...
                          storeSettings: form,
                          pdfBase64: "JVBERi0xLjQKJ..." // Dummy PDF base64
                        })
                      });
                      if (res.ok) alert("¡Correo de prueba enviado con éxito! Revisa tu bandeja de entrada (y spam).");
                      else {
                        const err = await res.json();
                        alert("Error al enviar prueba: " + (err.error || "Error desconocido"));
                      }
                    } catch (e) {
                ...
                <button
                  ...
                  onClick={async () => {
                    ...
                    try {
                      ...
                      if (res.ok) alert("¡Correo de contacto enviado con éxito!");
                      else {
                        const err = await res.json();
                        alert("Error al enviar prueba: " + (err.error || "Error desconocido"));
                      }
