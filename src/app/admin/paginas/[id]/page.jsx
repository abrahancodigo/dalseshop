...
const SECTION_TYPES = [
  ...
  { type: "fullWidthImage", label: "Imagen Ancho Completo", icon: HiOutlineRectangleGroup, color: "#0984E3" },
];
...
const DEFAULT_SECTION_CONFIG = {
  ...
  customHtml: { code: "" },
  fullWidthImage: { image: "", alt: "", height: "auto", link: "", objectFit: "cover" },
};
    ...
    <>
      ...
      <div className={adminStyles.saveBar}>
        ...
        {canManage("pages") ? (
          ...
          <span className="btn btn-primary btn-lg" style={{ opacity: 0.5, cursor: "not-allowed" }} title="No tienes permisos para guardar páginas">
            Solo lectura
          </span>
        )}
      </div>
        ...
        <div>
          ...
          <div className="admin-form-group">
            <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", marginTop: "0.5rem" }}>
              ...
              <span style={{ fontSize: "0.875rem", color: "var(--admin-text)", fontWeight: 500 }}>
                Imagen clicable (abre modal a tamaño completo)
              </span>
            </div>
          </div>
        ...
        <div>
          ...
          {config.image && (
            <div style={{ marginTop: "0.5rem", marginBottom: "1rem" }}>
              <img src={config.image} alt="" style={{ width: "100%", maxHeight: 200, objectFit: "cover", borderRadius: 10 }} />
            </div>
          )}
          <div className="admin-form-group">
            <label className="admin-form-label">Texto alternativo (alt)</label>
            <input className="admin-form-input" value={config.alt || ""} onChange={(e) => handleChange("alt", e.target.value)} placeholder="Descripción de la imagen" />
          </div>
          <div className="admin-form-group">
            <label className="admin-form-label">Altura</label>
            <select className="admin-form-select" value={config.height || "auto"} onChange={(e) => handleChange("height", e.target.value)}>
              <option value="auto">Automática (proporcional)</option>
              <option value="300">300px</option>
              <option value="400">400px</option>
              <option value="500">500px</option>
              <option value="600">600px</option>
              <option value="fullscreen">Pantalla completa (100vh)</option>
            </select>
          </div>
          <div className="admin-form-group">
            <label className="admin-form-label">Estilo de la imagen</label>
            <select className="admin-form-select" value={config.objectFit || "cover"} onChange={(e) => handleChange("objectFit", e.target.value)}>
              <option value="cover">Cubrir (recorta para llenar)</option>
              <option value="contain">Contener (muestra completa)</option>
              <option value="center">Centrada sin recortar</option>
            </select>
          </div>
          <div className="admin-form-group">
            <label className="admin-form-label">Link (opcional)</label>
            <input className="admin-form-input" value={config.link || ""} onChange={(e) => handleChange("link", e.target.value)} placeholder="https://..." />
            <span className="admin-form-hint">Si se agrega un link, la imagen será clicable</span>
          </div>
        </div>
      );
